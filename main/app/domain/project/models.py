...
class Project(BaseEntity):
    ...
    post_production_support = Column(String(10), nullable=False)
...
class ProjectBaseDto(Object):
    ...
    budget_range: str = Field(..., title="Budget range", description="Your budget range for this project")
    timeline: str = Field(..., title="Timeline", description="How soon do you want this project delivered")

    what_building: str = Field(..., title="What you're building",
                               description="Be specific about your core idea, target users, and main value proposition")
    what_not_building: str = Field(..., title="What you're not building",
                                   description="This helps us focus on what matters most for your MVP")
    build_summary: Optional[str] = None
    customer_location: str = Field(..., title="Customer primary location",
                                   description="This helps us consider timezone, regulations and local preferences")
    ...
    post_production_support: str = Field(..., title="Post production support",
                                         description="How do we support you after production deployment")  # -1=not-sure, 0=no, 1=yes
